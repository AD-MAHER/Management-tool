...
import { Row, Modal, Button, Card, Tooltip } from 'antd';
            ...
            <BlogStyle>
                ...
                <div >
                    ...
                    <div >
                        ...
                        <span className="create-button"> <Button onClick={showModal}>Create</Button>
                            <Modal
                                xs sm md lg xl xxl
                                title="Basic Modal"
                    ...
                    <Row>
                        {post.map((i, index) => {
                            ...
                            return (
                                ...
                                <Tooltip key={index} placement="topRight" title={i.title}>
                                    <Card key={index}
                                    ...
                                    >
                                        ...
                                        <span className="icon-class data-class" >{editicon} &nbsp; &nbsp; <DeletePost /></span>
