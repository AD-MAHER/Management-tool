...
import UpdateUserModal from '../Module/globalComponents/Modal/User Modal/UpdateUserModal';
            ...
            <>
              <Tooltip placement="topRight" title="edit">
                <span style={{ cursor: 'pointer' }}>
                  <UpdateUserModal tokenz={token} openIcon={editicon} ModalNameButton={token} ModalName="Update User" />
             &nbsp; &nbsp;
             </span>
              </Tooltip>
